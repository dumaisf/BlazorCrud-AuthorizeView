...
#nullable restore
#line 5 "C:\Users\dumai\source\repos\BlazorCrud AuthorizeView\Client\Shared\GridWrapper.razor"
    ...
    /// <summary>
    /// Call when the filter has changed to refresh the <see cref="Rubrique"/>
    /// list.
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// Call when a rubrique is requested to be deleted.
    /// </summary>
    [Parameter]
    public EventCallback<int> DeleteRequested { get; set; }

    /// <summary>
    /// The id of the <see cref="Rubrique"/> to be deleted.
    /// </summary>
