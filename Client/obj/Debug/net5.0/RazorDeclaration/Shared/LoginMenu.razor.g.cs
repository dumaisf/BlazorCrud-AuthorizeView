...
#nullable disable
#nullable restore
#line 1 "C:\Users\dumai\source\repos\BlazorCrud AuthorizeView\Client\Shared\LoginMenu.razor"
...
#nullable restore
#line 41 "C:\Users\dumai\source\repos\BlazorCrud AuthorizeView\Client\Shared\LoginMenu.razor"
      
    private bool collapseDropDown = true;

    private string NavMenuCssClass => collapseDropDown ? null : "show";
    private string AriaExpanded => collapseDropDown ? "false" : "true";
    ...
    //    if (firstRender)
    //    {
    //        await JS.InvokeVoidAsync("DropdownSetup");
    //    }
    //}
